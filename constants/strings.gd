...
const TUTORIAL_BODY = """
Welcome to the dark and unforgiving world of "Keep Them Safe". In this game, you are the master of a fledgling village, striving to survive and thrive amidst relentless dangers. Your task is to manage resources, build structures, and ensure the well-being of your villagers. But you won’t face these challenges alone. Brave heroes will join your village, seeking refuge and purpose.
